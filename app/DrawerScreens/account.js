...
import { AccountData } from "../../customComponents/formData";
        ...
        return (
          <View>
            <CustomInput
              ...
              name={element.name}
              rules={{
                required: element.isRequired ? `${element.title} is required` : false,
              }}
              onChange={(value) =>
          ...
          <View style={styles.card}>
            <View style={styles.section}>
              ...
              <Collapsible collapsed={isSection1Collapsed}>
                {AccountData.elements.slice(0, 16).map((element, index) => (
