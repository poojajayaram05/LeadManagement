    ...
    <View style={styles.container}>
      ...
      <View style={styles.smallCardGroupContainer}>
        <View style={styles.row1}>
           <SmallCard label1={'Total Leads'} label2={'5'} isSelected={selectedCard === 0} onPress={() => handleCardPress(total_leads)} />
            <SmallCard label1={'Total Calls'} label2={'2'} isSelected={selectedCard === 1} onPress={() => handleCardPress(total_calls)} />
        </View>
        <View style={styles.row2}>
            <SmallCard label1={'Total Activities'} label2={'10'} isSelected={selectedCard === 2} onPress={() => handleCardPress(total_activites)} />
            <SmallCard label1={'Sales'} label2={'5M'} isSelected={selectedCard === 3} onPress={() => handleCardPress(sales)} />
        </View>
        </View>
